...
use App\Http\Controllers\EComm\CheckoutController;
use App\Http\Controllers\EComm\HomeController;
...
Route::name('ecomm.')->group(function () {
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['role:superadmin,admin'])->group(function () {
        Route::name('dashboard.')->prefix('dashboard')->group(function () {
            ...
            Route::post('/user/update/{user:id}', [UserController::class, 'update'])->name('user.update');
            Route::delete('/user/destroy/{user:id}', [UserController::class, 'destroy'])->name('user.destroy');
        });
    });
});
